 ...
 * Reload fixtures
 */
task('fixtures:reload', function () {
    $releasePath = env()->getReleasePath();

    run("php $releasePath/app/console doctrine:database:drop --force -q");
    run("php $releasePath/app/console doctrine:database:create");
    run("php $releasePath/app/console doctrine:schema:create");
    run("php $releasePath/app/console doctrine:fixtures:load --no-interaction");
})->desc('Reload fixtures');

task('mongodb:fixtures:reload', function () {
    $releasePath = env()->getReleasePath();

    run("php $releasePath/app/console doctrine:mongodb:schema:drop --force -q");
    run("php $releasePath/app/console doctrine:mongodb:schema:create");
    run("php $releasePath/app/console doctrine:mongodb:fixtures:load --no-interaction");
})->desc('Reload fixtures');
